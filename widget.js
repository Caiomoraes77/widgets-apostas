/* widgets-apostas v1.4 – subtítulo por marca + disclaimer minúsculo abaixo do botão */
(function(){
  ...
  const BRANDS = [
    {
      ...
      // subtítulo específico para a marca
    ...
    },
    {
      ...
      sub:"Bolões oficiais com mais números e mais chances reais de ganhar.",
  ...
  function start(){
    ...
    // ---- CSS (igual ao seu HTML, com disclaimer pequeno abaixo do botão) ----
    const css = `
    ...
    /* Disclaimer agora abaixo do botão, bem pequeno */
    .sorte-footer__disc{margin:0; font-size:10px; line-height:1.2; opacity:.8; max-width:300px; text-align:center}
    @media (max-width:720px){
      ...
      .sorte-footer__disc{font-size:9px; margin-top:2px}
    }
    ...
    // ---- HTML injetado (disclaimer movido para a direita, abaixo do botão) ----
    const html = `
    ...
    // empurra a página um pouco para não cobrir conteúdo
    const pad = document.createElement('style');
    pad.textContent = `body{padding-bottom:100px}@media(max-width:720px){body{padding-bottom:88px}}`;
