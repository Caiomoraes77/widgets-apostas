/* widgets-apostas v1.3 – DOM-ready + cache-bust friendly + console log */
(function(){
  ...
  function start(){
    console.log("%cwidgets-apostas v1.3 carregado","background:#0a5864;color:#fff;padding:2px 6px;border-radius:4px");
  ...
  // Espera DOM estar pronto (Wix às vezes injeta cedo)
